    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?=base_url('dashboard')?>">
                ...
                <div class="sidebar-brand-text mx-2 fw-light fs-6">Pemesanan</div>
            </a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?=base_url('tambah-pemesanan')?>">
                    <i class="fas fa-fw fa-table"></i><span>Pemesanan Kendaraan</span></a>
            </li>
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?=base_url('tambah-kendaraan')?>">Tambah Kendaraan</a>
                        <a class="collapse-item" href="<?=base_url('tambah-pegawai')?>">Tambah pegawai</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?=base_url('keluar')?>"><i
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">
                                    Hello, <?php echo session('username')?>
                                </span>
